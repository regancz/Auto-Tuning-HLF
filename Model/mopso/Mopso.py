...
import numpy as np
from Model.mopso import init
from Model.mopso import update
from Model.mopso import plot
from Model.mopso.p_objective import model_predict_four_metric
...
class Mopso:
    ...
    def initialize(self):
        ...
        # 初始化全局最优
        self.in_g, self.fitness_g = update.update_gbest_1(self.archive_in, self.archive_fitness, self.mesh_div,
                                                          self.particals)
